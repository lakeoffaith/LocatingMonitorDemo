<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="BatteryResetLog.aspx.cs"
    Inherits="NetRadio.LocatingMonitor.History.__BatteryResetLog" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CphRight" runat="server">
    ...
    <div class="tabitem">
        <NetRadio:TagLogFilter id="tagLogFilter" FacilityFilterRowVisible="false" runat="server" />
        <NetRadio:CollapseView ID="listPanel" runat="server">
					...
					<Content>
						<table class="grid alternate fixed">
							...
							<tr>
								<td colspan="3"><NetRadio:Pagination id="p" pageSize="20" mode="Redirect" class="p_left" runat="server" /></td>
							</tr>
						</table>
					</Content>
