<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="AbsenceLog.aspx.cs"
    Inherits="NetRadio.LocatingMonitor.History.__AbsenceLog" %>
        ...
        <NetRadio:CollapseView ID="listPanel" runat="server">
					...
					<Content>
						<table class="grid alternate fixed">
							...
							<tr>
								<td colspan="4"><NetRadio:Pagination id="p" pageSize="50" mode="Redirect" class="p_left" runat="server" /></td>
							</tr>
						</table>
					</Content>
