<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="AlertProcessed.aspx.cs"
    Inherits="NetRadio.LocatingMonitor.History.__AlertProcessed" %>
						...
						<Content>
							<table class="grid alternate fixed">
								<thead>
									...
									<th width="120">警告记录</th>
									<th width="200">发生位置</th>
									<th width="150">状态</th>
								...
								<asp:Repeater id="messageRepeater" onitemcreated="messageRepeater_ItemCreated" runat="server">
									<ItemTemplate>
										<tr id="tr" runat="server">
											...
											<td><NetRadio:Anchor id="alertDetail" target="new" runat="server" /></td>
										</tr>
									</ItemTemplate>
								</asp:Repeater>
<%--								<tr>
								...
								<tr>
									<td colspan="7"><NetRadio:Pagination id="p" mode="Postback" pagesize="20" class="p_left" onpageindexchanged="p_PageIndexChanged" runat="server" /></td>
								</tr>
							</table>
						</Content>
						<Footer />
