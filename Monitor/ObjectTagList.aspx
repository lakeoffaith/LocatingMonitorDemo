<%@ Page Language="C#"  MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="ObjectTagList.aspx.cs" Inherits="NetRadio.LocatingMonitor.Monitor.ObjectTagList" %>
							...
							<NetRadio:CollapseView id="searchResult" runat="server">
								...
								<Content>
									<table class="grid alternate fixed">
										<thead>
											<th><NetRadio:SortButton id="apNameSorter" text="地标名称" sortKey="APName" onclick="sorter_Click" runat="server" /></th>
											<th>MAC地址</th>
											<%--<th>SSID</th>
											<th>局域网IP</th>
											<th>AP定位</th>--%>
